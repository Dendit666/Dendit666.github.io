    ...
    <section class="register">
        <div class="container">
            <div class="row text-center">
                <div class="col-12">
                    <h2 class="text-center text-uppercase mb-4 fw-bold">Обновление данных</h2>
                </div>
            </div>
            <div class="row justify-content-center ">
                <div class="col-12 col-lg-6 border p-4 upd_form">
                    <div class="input-group mb-3">
                        <span class="input-group-text">Фамилия</span>
                        <input type="text" name='surname' class="form-control" value="<?=$_SESSION['surname']?>">
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" name='tel' class="form-control" value="<?=$_SESSION['tel']?>">
                    </div>
                    <button type="submit" class="btn btn-primary upd_but" name='upd_but'>Обновить</button>
                </div>
            </div>
        </div>
    </section>
